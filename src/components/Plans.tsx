...
export default function Plans() {
  ...
  return (
    <section id="plans" className="bg-[#0A0A0A] py-20 border-t border-zinc-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Maximize Seus Lucros: Escolha o Seu Plano
          </h2>
          <p className="text-lg text-gray-400 mb-8">
            Flexibilidade e poder de IA para todos os tamanhos de barbearia. Sem taxas escondidas.
          </p>
          ...
          {plans.map((plan) => {
            ...
            return (
              ...
              >
                ...
                >
                  {plan.highlighted ? 'Começar Agora (Recomendado)' : `Começar no ${plan.name.split(' ')[1]}`}
                </button>
              </div>
            );
          })}
